Describe "Install-D365SupportingSoftware Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter SoftwareName' {
			$parameter = (Get-Command Install-D365SupportingSoftware).Parameters['SoftwareName']
			$parameter.Name | Should -Be 'SoftwareName'
