Describe "Invoke-D365ModuleLabelGeneration Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter LogDir' {
			$parameter = (Get-Command Invoke-D365ModuleLabelGeneration).Parameters['LogDir']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Module -OutputDir -LogDir -MetaDataDir -ReferenceDir -BinDir -ShowOriginalProgress
		#>
	}
