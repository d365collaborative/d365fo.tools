Describe "Invoke-D365LcsDeployment Unit Tests" -Tag "Unit" {
	...
	Describe "Testing parameterset VM" {
		...
		VM -ProjectId -AssetId -EnvironmentId -BearerToken -LcsApiUri -FailOnErrorMessage -EnableException
		#>
	}
 	Describe "Testing parameterset Self-Service" {
		<#
		Self-Service -AssetId -EnvironmentId -UpdateName
		Self-Service -ProjectId -AssetId -EnvironmentId -UpdateName -BearerToken -LcsApiUri -FailOnErrorMessage -EnableException
		#>
	}
