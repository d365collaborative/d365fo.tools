Describe "Invoke-D365LcsUpload Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Invoke-D365LcsUpload).Parameters['ClientId']
		...
		It 'Should have the expected parameter Username' {
			$parameter = (Get-Command Invoke-D365LcsUpload).Parameters['Username']
		...
		It 'Should have the expected parameter Password' {
			$parameter = (Get-Command Invoke-D365LcsUpload).Parameters['Password']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -ProjectId -ClientId -Username -Password -FilePath -FileType -FileName -FileDescription -LcsApiUri
		#>
	}
