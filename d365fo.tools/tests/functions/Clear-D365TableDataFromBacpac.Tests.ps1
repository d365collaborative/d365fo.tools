Describe "Clear-D365TableDataFromBacpac Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should have the expected parameter ExtractionPath' {
			$parameter = (Get-Command Clear-D365TableDataFromBacpac).Parameters['ExtractionPath']
		...
		It 'Should have the expected parameter KeepFiles' {
			$parameter = (Get-Command Clear-D365TableDataFromBacpac).Parameters['KeepFiles']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Path -TableName -OutputPath -ExtractionPath -KeepFiles
		#>
	}
