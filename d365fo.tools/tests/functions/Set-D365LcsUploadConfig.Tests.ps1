Describe "Set-D365LcsUploadConfig Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Set-D365LcsUploadConfig).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter ProjectId' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['ProjectId']
		...
		It 'Should have the expected parameter ClientId' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['ClientId']
		...
		It 'Should have the expected parameter Username' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['Username']
		...
		It 'Should have the expected parameter Password' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['Password']
		...
		It 'Should have the expected parameter LcsApiUri' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['LcsApiUri']
		...
		It 'Should have the expected parameter ConfigStorageLocation' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['ConfigStorageLocation']
		...
		It 'Should have the expected parameter Temporary' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['Temporary']
		...
		It 'Should have the expected parameter Clear' {
			$parameter = (Get-Command Set-D365LcsUploadConfig).Parameters['Clear']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -ProjectId -ClientId -Username -Password -LcsApiUri -ConfigStorageLocation -Temporary -Clear
		#>
	}
