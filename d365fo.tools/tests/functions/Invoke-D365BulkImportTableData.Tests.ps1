Describe "Invoke-D365BulkImportTableData Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-D365BulkImportTableData).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Path' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['Path']
		...
		It 'Should have the expected parameter TableName' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['TableName']
		...
		It 'Should have the expected parameter Schema' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['Schema']
		...
		It 'Should have the expected parameter DatabaseServer' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['DatabaseServer']
		...
		It 'Should have the expected parameter DatabaseName' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['DatabaseName']
		...
		It 'Should have the expected parameter ShowOriginalProgress' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['ShowOriginalProgress']
		...
		It 'Should have the expected parameter OutputCommandOnly' {
			$parameter = (Get-Command Invoke-D365BulkImportTableData).Parameters['OutputCommandOnly']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Path -TableName -Schema -DatabaseServer -DatabaseName -ShowOriginalProgress -OutputCommandOnly
		#>
	}
