Describe "Initialize-D365TestAutomationCertificate Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		...
		It 'Should habe the expected parameter MakeCertExecutable' {
			$parameter = (Get-Command Initialize-D365TestAutomationCertificate).Parameters['MakeCertExecutable']
			$parameter.Name | Should -Be 'MakeCertExecutable'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -CertificateFileName -PrivateKeyFileName -Password -MakeCertExecutable
		#>
	}
