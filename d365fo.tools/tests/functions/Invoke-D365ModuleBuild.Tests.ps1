Describe "Invoke-D365ModuleBuild Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-D365ModuleBuild).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Module' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['Module']
		...
		It 'Should have the expected parameter OutputDir' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['OutputDir']
		...
		It 'Should have the expected parameter LogPath' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['LogPath']
		...
		It 'Should have the expected parameter MetaDataDir' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['MetaDataDir']
		...
		It 'Should have the expected parameter ReferenceDir' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['ReferenceDir']
		...
		It 'Should have the expected parameter BinDir' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['BinDir']
		...
		It 'Should have the expected parameter IncludeReports' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['IncludeReports']
			$parameter.Name | Should -Be 'IncludeReports'
		...
		It 'Should have the expected parameter ShowOriginalProgress' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['ShowOriginalProgress']
		...
		It 'Should have the expected parameter OutputCommandOnly' {
			$parameter = (Get-Command Invoke-D365ModuleBuild).Parameters['OutputCommandOnly']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Module -OutputDir -LogPath -MetaDataDir -ReferenceDir -BinDir -IncludeReports -ShowOriginalProgress -OutputCommandOnly
		#>
	}
