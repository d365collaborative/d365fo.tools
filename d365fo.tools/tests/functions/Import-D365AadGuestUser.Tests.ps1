Describe "Import-D365AadGuestUser Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Import-D365AadGuestUser).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Users' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['Users']
		...
		It 'Should have the expected parameter StartupCompany' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['StartupCompany']
		...
		It 'Should have the expected parameter DatabaseServer' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['DatabaseServer']
		...
		It 'Should have the expected parameter DatabaseName' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['DatabaseName']
		...
		It 'Should have the expected parameter SqlUser' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['SqlUser']
		...
		It 'Should have the expected parameter SqlPwd' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['SqlPwd']
		...
		It 'Should have the expected parameter IdPrefix' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['IdPrefix']
		...
		It 'Should have the expected parameter NameSuffix' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['NameSuffix']
		...
		It 'Should have the expected parameter IdValue' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['IdValue']
		...
		It 'Should have the expected parameter NameValue' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['NameValue']
		...
		It 'Should have the expected parameter AzureAdCredential' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['AzureAdCredential']
		...
		It 'Should have the expected parameter TenantId' {
			$parameter = (Get-Command Import-D365AadGuestUser).Parameters['TenantId']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Users
		__AllParameterSets -Users -StartupCompany -DatabaseServer -DatabaseName -SqlUser -SqlPwd -IdPrefix -NameSuffix -IdValue -NameValue -AzureAdCredential -TenantId
		#>
	}
