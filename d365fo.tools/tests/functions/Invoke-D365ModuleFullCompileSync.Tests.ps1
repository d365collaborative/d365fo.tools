Describe "Invoke-D365ModuleFullCompileSync Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-D365ModuleFullCompileSync).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter ModuleName' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['ModuleName']
		...
		It 'Should have the expected parameter OutputDir' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['OutputDir']
		...
		It 'Should have the expected parameter LogDir' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['LogDir']
		...
		It 'Should have the expected parameter MetaDataDir' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['MetaDataDir']
		...
		It 'Should have the expected parameter ReferenceDir' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['ReferenceDir']
		...
		It 'Should have the expected parameter BinDir' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['BinDir']
		...
		It 'Should have the expected parameter ShowOriginalProgress' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['ShowOriginalProgress']
		...
		It 'Should have the expected parameter OutputCommandOnly' {
			$parameter = (Get-Command Invoke-D365ModuleFullCompileSync).Parameters['OutputCommandOnly']
