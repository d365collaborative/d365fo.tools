...
function Get-D365LcsFileAsset {
    ...
    Get-LcsFileAsset -BearerToken $BearerToken -ProjectId $ProjectId -LcsApiUri $LcsApiUri -AssetId $AssetId -RetryTimeout $RetryTimeout
