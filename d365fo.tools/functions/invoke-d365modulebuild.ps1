    ...
    process {
        ...
        foreach ($moduleName in $moduleInputs) {
            ...
            if ($OutputCommandOnly) {
                ...
                Invoke-BuildTool -Executable $xppcExecutable -Params $xppcParams -ShowOriginalProgress:$ShowOriginalProgress -OutputCommandOnly:$OutputCommandOnly
                ...
                Invoke-BuildTool -Executable $labelExecutable -Params $labelParams -ShowOriginalProgress:$ShowOriginalProgress -OutputCommandOnly:$OutputCommandOnly
                ...
                if ($IncludeReports) {
                    ...
                    Invoke-BuildTool -Executable $reportsExecutable -Params $reportsParams -ShowOriginalProgress:$ShowOriginalProgress -OutputCommandOnly:$OutputCommandOnly
                }
            ...
            $xppcExitCode = Invoke-BuildTool -Executable $xppcExecutable -Params $xppcParams -ShowOriginalProgress:$ShowOriginalProgress
            ...
            if ($IncludeReports -and $xppcOk -and ($null -eq $labelFailure)) {
                ...
                $reportsExitCode = Invoke-BuildTool -Executable $reportsExecutable -Params $reportsParams -ShowOriginalProgress:$ShowOriginalProgress
